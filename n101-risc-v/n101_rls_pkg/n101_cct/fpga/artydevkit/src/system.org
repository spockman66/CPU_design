...
(
  ...
  wire dut_io_pads_jtag_TMS_out_o_oval;
  wire dut_io_pads_jtag_DRV_TMS_o_oval;
  ...
  wire dut_io_pads_jtag_TDO_o_oe = 1'b1;
  ...
  n100_soc_top dut
  (
    .por_rst_n(1'b1),// We just let the POR reset (reset the entire core and the JTAG) to not working
    .sys_rst_n(ck_rst),
                     //  The regular ck_rst will be handled by ck_rst
    .sys_clk(clk_16M),
    ...
    .io_pads_jtag_ap_o_oval(dut_io_pads_aon_pmu_vddpaden_o_oval)
