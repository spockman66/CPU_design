...
#####                wfi define              #####
set_property PACKAGE_PIN W10  [get_ports {evt_bar}]
set_property PACKAGE_PIN V10  [get_ports {nmi_bar}]
set_property PACKAGE_PIN Y12  [get_ports {core_wfi_mode}]
set_property PACKAGE_PIN Y11  [get_ports {core_sleep_value}]
