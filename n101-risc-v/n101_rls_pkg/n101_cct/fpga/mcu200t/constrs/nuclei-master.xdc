...
set_property PACKAGE_PIN AA21 [get_ports {gpio[30]}]
set_property PACKAGE_PIN AB21 [get_ports {gpio[29]}]
set_property PACKAGE_PIN AA20 [get_ports {gpio[28]}]
set_property PACKAGE_PIN AA18 [get_ports {gpio[27]}]
set_property PACKAGE_PIN AB20 [get_ports {gpio[26]}]
set_property PACKAGE_PIN AA19 [get_ports {gpio[25]}]
set_property PACKAGE_PIN AB18 [get_ports {gpio[24]}]
set_property PACKAGE_PIN W20  [get_ports {gpio[23]}]
set_property PACKAGE_PIN V19  [get_ports {gpio[22]}]
set_property PACKAGE_PIN Y19  [get_ports {gpio[21]}]
set_property PACKAGE_PIN U17  [get_ports {gpio[20]}]
set_property PACKAGE_PIN AB22 [get_ports {gpio[19]}]
set_property PACKAGE_PIN V20  [get_ports {gpio[18]}]
...
set_property PACKAGE_PIN V17  [get_ports {gpio[15]}]
set_property PACKAGE_PIN P14  [get_ports {gpio[14]}]
set_property PACKAGE_PIN V18  [get_ports {gpio[13]}]
set_property PACKAGE_PIN W17  [get_ports {gpio[12]}]
set_property PACKAGE_PIN W21  [get_ports {gpio[11]}]
set_property PACKAGE_PIN V22  [get_ports {gpio[10]}]
set_property PACKAGE_PIN W22  [get_ports {gpio[9]}]
set_property PACKAGE_PIN Y22  [get_ports {gpio[8]}]
set_property PACKAGE_PIN U20  [get_ports {gpio[7]}]
set_property PACKAGE_PIN N13  [get_ports {gpio[6]}]
set_property PACKAGE_PIN T20  [get_ports {gpio[5]}]
set_property PACKAGE_PIN R19  [get_ports {gpio[4]}]
set_property PACKAGE_PIN P19  [get_ports {gpio[3]}]
set_property PACKAGE_PIN P20  [get_ports {gpio[2]}]

## BTN_RIGHT
set_property PACKAGE_PIN U2   [get_ports {gpio[1]}]
## BTN_LEFT
set_property PACKAGE_PIN V2   [get_ports {gpio[0]}]

#####                wfi define              #####
set_property PACKAGE_PIN W1  [get_ports {evt_bar}]
set_property PACKAGE_PIN Y1  [get_ports {nmi_bar}]
set_property PACKAGE_PIN M13 [get_ports {core_wfi_mode}]
set_property PACKAGE_PIN E22 [get_ports {core_sleep_value}]

#####                wfi define              #####
set_property IOSTANDARD LVCMOS33 [get_ports  evt_bar    ]
#set_property PULLUP true [get_ports  evt_bar    ]

set_property IOSTANDARD LVCMOS33 [get_ports  nmi_bar   ]
