...
set CORE                          ""  ;#  The name of the top-level design
...
set ADDITIONAL_SEARCH_PATH        "$rtldir/core $rtldir/fab $rtldir/mems $rtldir/perips $rtldir/soc $rtldir/subsys "  ;#  Additional search path to be added to the default search path
...
set LIBRARY_DONT_USE_FILE        "constraints/dont_use_cel.tcl"   ;# Tcl file with library modifications for dont_use
