...
set DCRM_SDC_INPUT_FILE                                 constraints/${DESIGN_NAME}_dc.sdc
set DCRM_CONSTRAINTS_INPUT_FILE                         constraints/${DESIGN_NAME}.constraints.tcl
...
set DCRM_DCT_FLOORPLAN_INPUT_FILE                       ./constraints/${DESIGN_NAME}.dc.fp
set DCRM_DCT_PHYSICAL_CONSTRAINTS_INPUT_FILE            ./constraints/${DESIGN_NAME}.custom.fp
